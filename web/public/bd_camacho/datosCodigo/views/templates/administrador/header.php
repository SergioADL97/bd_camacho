	...
	<header class="header" style="z-index: 9000" >
		...
		<ul class="color-cabecera nav col-12 mr-auto"> <!--Barra de navegación-->
			<li class="nav-item ml-2">
				<a class="nav-link color-link text-white" href="../conjuntos/index.php">Conjuntos</a>
			</li>
			<li class="nav-item">
				<a class="nav-link color-link text-white" href="../torres/index.php">Torres</a>
			</li>
			<li class="nav-item">
				<a class="nav-link color-link text-white" href="../apartamentos/index.php">Apartamentos</a> 
			</li>
			<!-- formulario con api-->
